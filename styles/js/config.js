...
charadex.sheet = {
  ...
  id: "1bGeHSDWUdqYU3SbA-pwKLOa0t55G6CNYioVaNINT_1I",
  ...
  options: {
    ...
    statuses: ['All', 'Open for trade', 'Open for sale', 'Open for gift art', 'Open for gift writing', 'NFO', 'Voided'],
    rarity: ['All', 'Common', 'Uncommon', 'Rare', 'Corrupted'],
    species: ['All', 'Digidevil'],
